...
//==============================================================================
public class TestProject5   extends Activity
{
    //==============================================================================
    static
    {
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            TestProject5.this.alertDismissed (callback, 0);
                        }
                    });
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            TestProject5.this.alertDismissed (callback, 1);
                        }
                    })
               ...
               .setNegativeButton ("No", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            TestProject5.this.alertDismissed (callback, 2);
                        }
                    })
