...
#ifndef TREMOLOOPERATORCOMPONENT_H_INCLUDED
#define TREMOLOOPERATORCOMPONENT_H_INCLUDED
...
*/
class TremoloOperatorContentComponent   : public Component,
                                    public AudioProcessor,
                                   public Slider::Listener
{
public:
    //==============================================================================
    TremoloOperatorContentComponent();
    TremoloOperatorContentComponent(Image, double);
    ~TremoloOperatorContentComponent();
...
private:
    ...
    int pos;
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TremoloOperatorContentComponent)
};


#endif  // TREMOLOOPERATORCOMPONENT_H_INCLUDED
