...
#ifndef SINEOPERATORCOMPONENT_H_INCLUDED
#define SINEOPERATORCOMPONENT_H_INCLUDED
...
*/
class SineOperatorContentComponent   : public Component,
...
public:
    //==============================================================================
    SineOperatorContentComponent();
    SineOperatorContentComponent(Image, double);
    ~SineOperatorContentComponent();
    ...
    bool setSustained(bool sustained);
...
private:
    ...
    int pos;
    int timer;
    int envSize, attackSize, decaySize;
    /*
    File *soundFile;
     ...
     */
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SineOperatorContentComponent)
};


#endif  // SINEOPERATORCOMPONENT_H_INCLUDED
