...
#ifndef ECHOOPERATORCOMPONENT_H_INCLUDED
#define ECHOOPERATORCOMPONENT_H_INCLUDED
...
*/
class EchoOperatorContentComponent   : public Component,
                                    public AudioProcessor,
                                   public Slider::Listener
{
public:
    //==============================================================================
    EchoOperatorContentComponent();
    EchoOperatorContentComponent(Image, double);
    ~EchoOperatorContentComponent();
    ...
    double getEchoDelay();
    void setEchoDelay(double delay);
    float getEchoIntensity();
...
private:
    ...
    float intensity;
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EchoOperatorContentComponent)
};


#endif  // ECHOOPERATORCOMPONENT_H_INCLUDED
